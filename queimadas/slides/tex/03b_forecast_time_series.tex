...
\subsubsection{Do the forecasts extend well along time?}

\begin{frame}
  \frametitle{Do the forecasts extend well along time?}
  \begin{itemize}
    \item Use the models to forecast the time series of the union of data
      comming from all sources.
  \end{itemize}
\end{frame}
