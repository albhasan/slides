    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item Most \text{R} analysis is done using data frames or 
                    tibbles.
...
\begin{frame}
	...
	\centering
	\small
	\include{./tables/summary_doc_type_total.tex}
\end{frame}
...
\begin{frame}
	...
	\centering
	\small
	\include{./tables/summary_main_information.tex}
\end{frame}
...
\begin{frame}
	...
	\centering
	\small
	\include{./tables/summary_doc_type_doi.tex}
\end{frame}
...
\begin{frame}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\centering
			\small
			\include{./tables/summary_most_prod_authors.tex}
		\end{column}
		\begin{column}{0.5\textwidth}
			\centering
			\small
			\include{./tables/summary_most_prod_authors_frac.tex}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\centering
	\small
	\include{./tables/summary_most_cited_papers.tex}
\end{frame}
...
\begin{frame}
	...
	\centering
	\scriptsize
	\include{./tables/summary_most_rel_sources.tex}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\centering
			\scriptsize
			\include{./tables/summary_most_rel_keywords.tex}
		\end{column}
		\begin{column}{0.5\textwidth}
			\centering
			\scriptsize
			\include{./tables/summary_most_rel_keywords_kwplus.tex}
		\end{column}
	\end{columns}
\end{frame}
